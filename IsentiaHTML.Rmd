...
## Business Problem
Just from observing the raw data, we can already tell that the content comes from personal posts that contain the word "juice". The word is used in different senses such as in beverages, as a word for creative inspiration, and energy in batteries. In order to gather insights, we will be doing **topic modeling**, and look for the **top n-grams** to learn what people think about when they mention "juice".
